...
export default function AdminSchemaRegistry() {

    return (
        <DashboardLayout role="admin" title="Schema Registry" description="Manage Avro, JSON and Protobuf schemas for your Kafka topics.">
                ...
                <CardHeader className="flex flex-row items-center justify-between px-6 pt-6 pb-4 mb-2">
                    <div className="space-y-1.5">
                        ...
                        <CardDescription className="text-slate-500 dark:text-slate-400 font-medium">
                            Manage and govern your Kafka topic schemas.
                        </CardDescription>
                    </div>
                </CardHeader>
